...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('listings_listing', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Listing.price'
        db.delete_column('listings_listing', 'price')
