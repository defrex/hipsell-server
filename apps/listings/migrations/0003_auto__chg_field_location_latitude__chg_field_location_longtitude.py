...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('listings_location', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=4))

        # Changing field 'Location.longtitude'
        db.alter_column('listings_location', 'longtitude', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=4))


    def backwards(self, orm):
        
        # Changing field 'Location.latitude'
        db.alter_column('listings_location', 'latitude', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Location.longtitude'
        db.alter_column('listings_location', 'longtitude', self.gf('django.db.models.fields.IntegerField')())
